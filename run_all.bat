...
python evaluate_maskrcnn.py --ann_file %coco_ann_file% --img_dir %coco_img_dir% --max_samples 100 --fix_input_size %height% %width% --onnx_backbone ./model/maskrcnn_backbone_quant.onnx --onnx_ep vai
